...
class RetrieveThenReadApproach(Approach):
    ...
    system_chat_template = (
        "You are an intelligent assistant helping Assistant helps the healthcare practitioners with their clinical trials questions based on current knowledge base. Be brief in your answers. "
    ...
    question = """
'What were the outcomes or results of the clinical trial for condition Alcoholism?'

Sources:
info1.txt: It was successfully implemented.
info2.pdf: For few trials the enrollments was as low as 1.
"""
    answer = "The outcomes of clinical trials for alcoholism was successful [info1.txt] and there were fewer enrollments for some trials [info2.pdf]."
